...
const blogs = [
  { id: 1, title: "Blog One", description: "A great blog post", img: blogImg1 },
  {
    id: 2,
    title: "Blog Two",
    description: "Another insightful blog",
    img: blogImg2,
  },
  {
    id: 3,
  ...
  return (
    <div className="projectsectioner">
      <Container className="project-section2 py-5">
        ...
        >
          Explore some of our best projects that showcase innovation,
          creativity, and excellence in technology and design.
        </motion.p>
